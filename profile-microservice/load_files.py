...
def load_repo_files(repo_path):
    ...
    for root, dirs, files in os.walk(repo_path):
        ...
        for file in files:
            if file.endswith((".md", ".py", ".txt", ".js", ".html", ".css", ".hcl", ".sh", ".json", ".yaml", ".yml",".java")):
                ...
                try:
                    ...
                    for doc in loaded_docs:
                        ...
                        doc.metadata["type"] = (
                            "code" if ext in {"py", "js", "sh",".java"} else
...
if __name__ == "__main__":
    repo_path = "/Users/examplerepo/spotify_test/spotify-api-clone"
